...
let seedHex =  properties.seedHex;
let transactionHex = properties.transactionHex;    
...
function signTransaction(seedHex, transactionHex) {
  ...
  return signedTransactionBytes.toString('hex');
    ...
    let signedtxn = signTransaction(seedHex, transactionHex);

return {signedTxn: signedtxn}
